    ...
    <>
      <div className="m-10 mx-auto grid max-w-screen-lg  gap-5 sm:grid-cols-3">
        <div className="px-4 py-6 shadow-lg shadow-gray-300">
          ...
          <button className="mt-6 h-10 w-28  rounded-lg bg-yellow-500 text-sm font-bold text-black shadow-lg hover:bg-yellow-700">
        ...
        <div className="px-4 py-6 shadow-lg shadow-gray-300">
          ...
          <p className="mt-4 font-medium">Coaches</p>
          <p className="mt-2 text-xl font-medium">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="inline h-4 w-4"
          ...
          <button className="mt-6 h-10 w-28  rounded-lg bg-yellow-500 text-sm font-bold text-black shadow-lg hover:bg-yellow-700">
            <Link to={"/dashboard/Coaches"}>More info</Link>
          </button>
        </div>
        ...
        <div className="px-4 py-6 shadow-lg shadow-gray-300">
          ...
          <p className="mt-4 font-medium">purchases </p>
          <p className="mt-2 text-xl font-medium">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="inline h-4 w-4"
          ...
          <button className="mt-6 h-10 w-28  rounded-lg bg-yellow-500 text-sm font-bold text-black shadow-lg hover:bg-yellow-700">
            <Link to={"/dashboard/Purchases"}>More info</Link>
          </button>
        </div>
      </div>
    </>
